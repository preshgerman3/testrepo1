...
public class DeckOfCards {
    ...
    public void draw() {
        ...
        int intRankBeforeDraw = intRank(hand2);
        ...
        System.out.println();
        resetParams();
        int intRankAfterDraw = intRank(hand2);
        printHand(hand2);
        printRankings(hand2);

        if (!(isCondition)) {
            if (intRankAfterDraw > intRankBeforeDraw) {
                System.out.println("Draw improved hand");
            } else if (intRankAfterDraw < intRankBeforeDraw) {
                System.out.println("Draw worsened hand");
            } else {
                System.out.println("No significant change due to draw");
            } 
            System.out.println();
        } intRankHand2 = intRankAfterDraw;
    ...
    public ArrayList<Card> swapCardsBetweenRemainingListAndSecondHand(ArrayList<Card> list1, ArrayList<Card> list2) {
        ...
        ArrayList<Card> combinedSwappingLists = new ArrayList<>();
        combinedSwappingLists.addAll(list1);
        combinedSwappingLists.addAll(list2);
        return combinedSwappingLists;
    } 
    ...
    public ArrayList<Card> twoHands() {
